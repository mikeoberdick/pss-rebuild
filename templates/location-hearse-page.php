<?php
/**
 * Template Name: Location Hearse Page
 * @package understrap
**/
...
<div id="locationHearse" class = "page-wrapper">
	<div id="content" tabindex="-1">
		<main class="site-main" id="main">
			<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				...
				<?php $hero = get_field('hearse_hero', 'option' ); ?>
				...
				<?php $intro = get_field('hearse_introductory_section', 'option'); ?>
				...
				<?php $sectionOne = get_field('hearse_section_one', 'option'); ?>
				...
				<div id="links" class = "container-fluid">
					<div class="row">
						<?php if ( have_rows('hearse_links', 'option') ) : while ( have_rows('hearse_links', 'option') ) : the_row(); ?>
				...
				<?php $sectionTwo = get_field('hearse_section_two', 'option'); ?>
				...
				<?php $testimonial = get_field('hearse_testimonial', 'option'); ?>
				...
				<div id="images" class = "container">
					<div class="row">
						<?php if ( have_rows('hearse_image_gallery', 'option') ) : while ( have_rows('hearse_image_gallery', 'option') ) : the_row(); ?>
						<div class="col-md-4">
